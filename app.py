...
if authentification_status :
    ...
    if __name__ == "__main__": 
        ...
        if selection_page == "Support":
            ...
            from hubspot import activite_ticket_source_client
            ...
            def support():
                ...
                semaines_df = df_stellair["Semaine"].unique().tolist()
                data_affid_hubspot_ticket = df_affid_hubspot_ticket[df_affid_hubspot_ticket["Semaine"].isin(semaines_df)]
                
                graph_activite_ticket_source_client_ssia = activite_ticket_source_client(data_affid_hubspot_ticket, 'SSIA', semaines_df)
                ...
                taux_reponse, mean_difference, df_taux_reponse = calcul_taux_reponse2(df_support_filtered)
                ...
                st.plotly_chart(graph_activite_ticket_source_client_ssia)
