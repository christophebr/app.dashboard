...
def metrics(df, df3, options_partenaire, options_formulaire, defaut_val):
    ...
    #df_formulaire = df_formulaire[['Semaine','Clé de ticket', 'Résumé', 'Descriptif', 'main_category']]
    ...
    fig_box_delai.update_layout(title='Délai de prise en charge', yaxis_title='Temps (minutes)')
